  ...
  return (
    <footer className="border-t border-white/10">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-6 py-8 sm:flex-row sm:justify-between sm:px-8 lg:px-10">
        <Link
          href="/"
          className="font-[family:var(--font-heading)] text-xs font-semibold tracking-[0.18em] text-zinc-600 uppercase transition hover:text-white"
        ...
        <p className="font-[family:var(--font-data)] text-[10px] text-zinc-700">
